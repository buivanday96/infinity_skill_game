...
_SkillTreeState _$SkillTreeStateFromJson(
  Map<String, dynamic> json,
) => _SkillTreeState(
  nodes:
      (json['nodes'] as Map<String, dynamic>?)?.map(
        (k, e) => MapEntry(
          $enumDecode(_$UpgradeEnumMap, k),
          SkillNode.fromJson(e as Map<String, dynamic>),
        ),
      ) ??
      const {},
  selectedNodeId: $enumDecodeNullable(_$UpgradeEnumMap, json['selectedNodeId']),
  ...
  totalYellowStarPoints: (json['totalYellowStarPoints'] as num?)?.toInt() ?? 19,
  ...
  totalGreenCrownPoints: (json['totalGreenCrownPoints'] as num?)?.toInt() ?? 36,
);

Map<String, dynamic> _$SkillTreeStateToJson(_SkillTreeState instance) =>
    <String, dynamic>{
      'nodes': instance.nodes.map((k, e) => MapEntry(_$UpgradeEnumMap[k]!, e)),
      'selectedNodeId': _$UpgradeEnumMap[instance.selectedNodeId],
      'unspentPoints': instance.unspentPoints,
      'totalPoints': instance.totalPoints,
      'blueSquarePoints': instance.blueSquarePoints,
      'totalBlueSquarePoints': instance.totalBlueSquarePoints,
      'yellowStarPoints': instance.yellowStarPoints,
      'totalYellowStarPoints': instance.totalYellowStarPoints,
      'pinkHourglassPoints': instance.pinkHourglassPoints,
      'totalPinkHourglassPoints': instance.totalPinkHourglassPoints,
      'greenCrownPoints': instance.greenCrownPoints,
      'totalGreenCrownPoints': instance.totalGreenCrownPoints,
    };
